        ...
        <div className='my-32 mt-64'>
            ...
            <div className='w-[75%] mx-auto relative lg:w-[90%] md:w-full'>
                ...
                <ul className='w-full flex flex-col items-start justify-between ml-4  xs:ml-2 '>
                    <Details position="Software Developer" company="Groyyo" companyLink="https://groyyo.com/" time="May 2024 - Continue" address="Bangalore" work="Improved frontend logic and optimized algorithms for better efficiency | Collaborated with teams to ensure design consistency | Enhanced UI/UX for a seamless user experience." />
                    <Details position="Solution Architect Intern" company="Hyperverge" companyLink="https://hyperverge.co/" time="September 2023 - May 2024" address="Bangalore" work="Designed 50+ JSON workflows | Optimized processes | Developed innovative client solutions | Conducted POCs for clients | Demonstrated new technologies and processes." />
